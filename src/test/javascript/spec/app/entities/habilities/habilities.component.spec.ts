...
import { HabilitiesComponent } from 'app/entities/habilities/habilities.component';
...
describe('Component Tests', () => {
    describe('Habilities Management Component', () => {
        let comp: HabilitiesComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(HabilitiesComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.habilities[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
